...
if($_SESSION['login'])
{
    ...
    if(isset($_POST['submit']))
    {
        ...
        if($answer == "dennis m. ritchie" || $answer == "dennis ritchie")
        {
...
<body>
    ...
    <h2 style="margin-bottom:50px; color:white;"> M mq aygbow, ppygib, krb kr cxspwssc wsmgccw
    ...
    <h5 class="help" style="color:white; border:1px solid white; padding:15px; width:10%; margin:auto auto; cursor:help"> HINT </h5>
        <div style="color:white margin:top:20px; padding:20px; background-color:black;" class="hints jumbotron tex-center"> indéchiffrable 300 Years!   </div>


    </div>
    <div class="text-center" style="margin-bottom:100px; margin:auto auto; padding-top:50px; padding-bottom:50px;">
    <img src="../includes/page1ans.jpg" style="margin:auto auto; width:50%; border-radius:10px;">
    </div>
